...
let s:palette = {
      ...
      \ 'bg1':        ['#483858',   '236',  'DarkGrey'],
      \ 'bg2':        ['#2F344D',   '236',  'DarkGrey'],
      \ 'bg3':        ['#434964',   '237',  'DarkGrey'],
      \ 'bg4':        ['#3A405E',   '237',  'Grey'],
      ...
      \ 'fg':         ['#C9C1D6',   '250',  'White'],
      \ 'red':        ['#FF4854',   '203',  'Red'],
      \ 'orange':     ['#FFA024',   '215',  'Orange'],
      \ 'yellow':     ['#FFEF50',   '179',  'Yellow'],
      \ 'green':      ['#75AF71',   '107',  'Green'],
      \ 'blue':       ['#4594BF',   '110',  'Blue'],
      \ 'purple':     ['#CC65F9',   '176',  'Magenta'],
      \ 'grey':       ['#999999',   '246',  'LightGrey'],
      \ 'none':       ['NONE',      'NONE', 'NONE']
      \ }
...
call s:HL('Boolean', s:palette.purple, s:palette.none, 'italic')
...
call s:HL('Todo', s:palette.blue, s:palette.none, 'underline')
...
call s:HL('GreenItalic', s:palette.green, s:palette.none, 'italic')
...
highlight! link pythonClass BlueItalic
...
highlight! link pythonFunction Orange
highlight! link pythonDecorator OrangeItalic
highlight! link pythonInclude Include
highlight! link pythonImport BlueItalic
highlight! link pythonOperator RedItalic
highlight! link pythonRawOperator Red
...
highlight! link haskellDeclKeyword BlueItalic
highlight! link haskellWhere PurpleItalic
highlight! link haskellDeriveKeyword Red
highlight! link haskellOperators Red
